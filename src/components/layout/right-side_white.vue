                                        ...
                                        <ul class="list-unstyled margin-none">
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar6.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Annette
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Jordan
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar2.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Stewart
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar3.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-warning"></i> Alfred
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar4.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-danger"></i> Eileen
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar5.jpg" class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-muted"></i> Robert
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img src="../../assets/img/authors/avatar7.jpg" class="img-circle float-right" alt="avatar-image">
