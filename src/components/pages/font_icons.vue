                        ...
                        <div class="icon_group">
                            <div class="icon_set text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2"><i class="ti-vector icons"></i></div>
                            ...
                            <div class="icon_cover text-center">
                                <router-link class="btn btn-primary" to="/themify_icons">View All
                                </router-link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="icon_group">
                            <div class="icon_set fontawesome_icons text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2"><i class="fa fa-fw ti-close removecard clickable"></i>
                                    </div>
                            ...
                            <div class="icon_cover text-center">
                                <router-link class="btn btn-primary" to="/fontawesome_icons">View All
                                </router-link>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="icon_group">
                            ...
                            <div class="icon_cover text-center">
                                <router-link class="btn btn-primary" to="/simple_line_icons">View All
                                </router-link>
                            </div>
                        </div>
                    </div>
...
<style src="../../assets/css/custom_css/fonts.css"></style>
