            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="nonsingle-stop" class="d-none">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row m-t-10">
                                        <div class="col-sm-6">
                                            <a class="btn btn-secondary text-white" id="add-flight">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <form id="form-validation" action="#/user/realtime_form" class="form-horizontal">
                                    <div class="form-group">
    ...
    export default {
        ...
        mounted: function() {
            ...
            $("#one_way").on("click", function() {
                $("#single-stop").show();
                $("#nonsingle-stop").addClass("d-none").removeClass("d-block");
            ...
            $("#multi_stops").on("click", function() {
                $("#single-stop").hide();
                $("#nonsingle-stop").removeClass("d-none").addClass("d-block");
                $('.trip-type').find('i').addClass('ti-arrow-up').removeClass('ti-exchange-vertical');
            });
            ...
            $('#add-flight').on('click', function() {
                if (i < 5) {
                    var xs_element = "<div class='trip-type d-sm-none'> <i class='fa ti-arrow-right icon'></i> </div>";
...
<style src="../../assets/css/custom_css/realtime_form.css"></style>