                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control float-right" data-language='en'
                                           id="my-element"/>
                                </div>
                                <!-- /.input group -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control float-right" id="minMaxExample">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="timepick" class="form-control float-right" data-language='en'
