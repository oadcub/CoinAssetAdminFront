...
<script>
import insignia from "../../vendors/insignia/dist/insignia.min.js"
export default {
    name: "tags_input",
    mounted: function() {
        'use strict';
...
<style src="../../vendors/insignia/dist/insignia.min.css"></style>
<style src="../../assets/css/custom_css/insignia_custom.css"></style>
