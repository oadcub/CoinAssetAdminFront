<template>
    <div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>Labadie</td>
                                    <td>Music</td>
                                    <td><span class="badge badge-success p-1">Suspended</span></td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Jackson</td>
                                ...
                                <tr>
                                    ...
                                    <td>Kovacek</td>
                                    <td>Garden</td>
                                    <td><span class="badge badge-info">Suspended</span></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <b-btn v-b-modal.modaledit variant="primary"><span class="fa fa-fw ti-pencil"></span></b-btn>
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            <b-btn v-b-modal.modaldelete variant="danger"><span class="fa fa-fw ti-trash"></span></b-btn>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
        ...
        <b-modal id="modaledit" title="Edit details" >
            ...
            <div slot="modal-footer" class="w-100">
                <b-btn size="sm" class="float-right" variant="success" >
                    <span class="ti-check"></span>Update
                </b-btn>
            </div>
        </b-modal>
            <!-- /.modal-dialog -->
        ...
        <b-modal id="modaldelete" title="Edit details" >
            <div class="modal-body">
                <div class="alert alert-info">
                    <span class="glyphicon glyphicon-info-sign"></span>&nbsp; Are you sure you want to
                    delete this record ?
            ...
            <div slot="modal-footer" class="float-right">
                <button type="button" class="btn btn-danger" data-dismiss="modal">
                    <span class="ti-check"></span> Yes
                </button>
                <button type="button" class="btn btn-success" data-dismiss="modal">
                    <span class="ti-close"></span> No
                </button>
            </div>
        </b-modal>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="bg-primary">Hailey Bruen</td>
                                    <td class="bg-primary">Hailey.Bruen23</td>
                                    <td class="bg-primary">970-037-5586</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="bg-primary">9</td>
                                    <td class="bg-primary">Mariela Corwin</td>
                                    <td class="bg-primary">Mariela.Corwin</td>
                                    <td class="bg-primary">158-603-0375</td>
                                </tr>
                                <tr>
