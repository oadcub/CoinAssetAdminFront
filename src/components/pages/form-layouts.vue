                                        ...
                                        <form action="#">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <div class="col-sm-4 col-6 float-md-right txt_media">
                                                                <label class="form-control-label">
                                                                    First Name:
                                                                </label></div>
                    ...
                    <b-tab title="Form Striped" >
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header striped_full">
                                        <h3 class="card-title">
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputPassword" class="control-label col-sm-3 float-md-right txt_media">Password</label>
                                                <div class="col-sm-9">
                                                    <input type="password" class="form-control"
                                    ...
                                    <div class="card-body">
                                        <form class="d-inline">
                                            <div class="row">
                                                <div class="col-12 m-t-10">
                                                    <div class="input-group">
                                                        <div class="input-group-btn">
                                                            <b-dropdown text="Action" variant="info">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-btn fisrt_dropdwn">
                                                        <b-dropdown text="Action" variant="warning">
                                                            <b-dropdown-item-button>action</b-dropdown-item-button>
                                                            <b-dropdown-item-button>another action</b-dropdown-item-button>
                                                            <b-dropdown-item-button >something else here</b-dropdown-item-button>
                                                            <b-dropdown-divider></b-dropdown-divider>
                                        ...
                                        <form class="form-horizontal">
                                            <fieldset>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="email" class="form-control"
                                                               id="inputEmail3" placeholder="Email"  disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-3 txt_media">
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                           <b-form-radio checked="false" name="radio_twitter">HTML</b-form-radio>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <b-form-radio checked="false" name="radio_twitter">HTML</b-form-radio>
                                                        </div>
                                    ...
                                    <div class="card-body">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <b-form-radio checked="false" name="radio_ganeral_inline">HTML</b-form-radio>
                                                    <b-form-radio checked="false" name="radio_ganeral_inline">CSS</b-form-radio>
                                                    <b-form-radio checked="false" name="radio_ganeral_inline">JavaScript</b-form-radio>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-3 float-md-right txt_media">
                                ...
                                <div class="card card_brdr">
                                    ...
                                    <div class="card-body">
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label float-md-right txt_media">Password</label>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                            <i class="fa ti-key"></i>
                                            ...
                                            <div class="form-group row has-success">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group input-icon right">
                                                                    <span class="input-group-addon is-valid">
                                                                            <i class="fa ti-email"></i>
                                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label float-md-right">
                                                    Validation Password
                                                </label>
                                                <div class="col-sm-8">
                                                    <div class="input-group input-icon right">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <b-form-radio checked="false"></b-form-radio>
                                                        </div>
                                                        <input type="text" class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label float-md-right txt_media">Readonly</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control"
