...
<div>
    <div class="row">
            ...
            <div>
                <div class="widget-bg-color-icon card-box front">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b>322</b></h3>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
                        <p>Daily Activities</p>
                        <hr>
                        <p><a class='btn btn-info' href='#/admin_activities'>View</a></p>
                    </div>
        ...
        <div class="col-sm-6 col-md-6 col-xl-3">
            <div>
                <div class="widget-bg-color-icon card-box front">
                    ...
                    <div class="text-right">
                        <h3><b id="widget_count3">75</b></h3>
                        <p>Users Pending</p>
                        <hr>
                        <p><a class='btn btn-info' href='#/verify_users'>Verify</a></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-xl-3">
            <div >
                <div class="widget-bg-color-icon card-box front">
                    <div class="bg-icon float-left">
                        <i class="ti-world text-warning"></i>
                    </div>
                    <div class="text-right">
                        <h3 class="text-dark"><b>62</b></h3>
                        <p>Coperate Pending</p>
                        <hr>
                        <p><a class='btn btn-info' href='#/verify_users'>Verify</a></p>
                    </div>
                    <div class="clearfix"></div>
        ...
        <div class="col-sm-6 col-md-6 col-xl-3">
            <div >
                <div class="widget-bg-color-icon card-box front">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b>165</b></h3>
                        <p>Bank Account Pending</p><hr>
                        <p><a class='btn btn-info' href='#/verify_users'>Verify</a></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
 ...
 <div class="row">
            <div class="col-lg-6 col-sm-6 col-xl-6">
                        ...
                        <ul class="schedule-cont">
                            <li class="item danger">
                                <div class="data">
                                    ...
                                    <p><span class="text-danger">Staff1</span> 
                                    change balance from <span class="text-danger">500$</span> 
                                    to  <span class="text-danger">650$</span> for <span class="text-info">oadcub@gmail.com</span> </p>
                                </div>
                            </li>
                            <li class="item success">
                                <div class="data">
                                    <div class="time text-muted"> 7min ago</div>
                                    <p><span class="text-danger">Staff3</span> 
                                    Approve Bank Account <span class="text-success">TMB</span> for  <span class="text-info">oadcub@gmail.com</span></p>
                                </div>
                            </li>
                            <li class="item info">
                                <div class="data">
                                   ...
                                   <p><span class="text-danger">Staff1</span> 
                                    Approve User <span class="text-info">oadcub@gmail.com</span> </p>
                                </div>
                            </li>
                            <li class="item warning">
                                <div class="data">
                                    ...
                                    <p><span class="text-danger">Staff1</span> 
                                    Approve Coperate <span class="text-warning">COINASSET COMPANY</span> 
                                    by  <span class="text-warning">invest@coinasset.co.th</span> </p>
                                </div>
                            </li>
                        </ul>
                    </div>
             ...
             <div class="col-lg-6 col-sm-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Recent User Activities</h3>
                    </div>
                    <div class="card-body">
                        <ul class="schedule-cont">
                            <li class="item info">
                                <div class="data">
                                    <div class="time text-muted"> Just now</div>
                                      <p><span class="text-info">test1@gmail.com</span> 
                                    Requested for Verify User <span class="text-info">test1@gmail.com</span>   </p>
                                </div>
                            </li>
                            <li class="item success">
                                <div class="data">
                                    <div class="time text-muted"> 11min ago</div>
                                    <p><span class="text-info">test1@gmail.com</span> 
                                    Requested for Verify Bank Account <span class="text-success">SCB</span>   </p>
                                </div>
                            </li>
                            <li class="item warning">
                                <div class="data">
                                    <div class="time text-muted">2hours ago</div>
                                     <p><span class="text-warning">invest@coinasset.com</span> 
                                    Requested for Verify Coperate <span class="text-warning">COINASSET COMPANY</span>   </p>
                                </div>
                            </li>
                            <li class="item success">
                                <div class="data">
                                    <div class="time text-muted"> Yesterday</div>
                                     <p><span class="text-info">test1@gmail.com</span> 
                                    Requested for Verify Bank Account <span class="text-success">TMB</span>   </p>
                                </div>
                            </li>
                        </ul>
                    </div>
 ...
 <div class="col-sm-12 ">
                    <div class="card nvd3-card">
                        <div class="card-header">
                            <h3 class="card-title">Verify Status Per Month</h3>
                        </div>
                        <div class="card-body">
...
import project_status from "./dashboard/project_status";
import vScroll from "../../components/plugins/scroll/vScroll.vue"

export default {
    name: 'index',
    components:{
        chat,timeline,project_status,vScroll
    },
    data() {
        return {
            bar_color: "#ccc",
