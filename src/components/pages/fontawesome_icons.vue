...
<script>
import toastr from "../../vendors/toastr/toastr.min.js"
export default {
...
<style src="../../vendors/toastr/toastr.min.css"></style>
<style src="../../assets/css/custom_css/fontawesome_icons.css"></style>
