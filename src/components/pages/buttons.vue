<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card quick_shortcuts">
                    <div class="card-header">
                        <h3 class="card-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <button class="ladda-button btn btn-warning  button_normal"
...
<script>
    import buttons from "../../vendors/Buttons/js/buttons.js"
...
<style src="../../vendors/hover/css/hover-min.css"></style>

<style lang="sass">
    @import "../../assets/sass/buttons/buttons.scss"
</style>
<style src="../../vendors/ladda-bootstrap/dist/ladda-themeless.min.css"></style>
