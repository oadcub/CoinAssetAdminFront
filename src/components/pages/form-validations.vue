        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form id="form-validation" action="" method="post"
                              class="form-horizontal">
                            <div class="form-group row">
                                <div class="col-md-4 float-md-right txt_media">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group label-floating">
                                            <label  class="control-label m-t-10" for="card_num">Card Number</label>
                                            <input name="number" required type="text" placeholder=""
                                                   class="form-control" width="card_num" id="card_num"/>

                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label" for="cardexpire">Expiry Date</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group label-floating">
                                            <label class="control-label" for="your_name">Name on Card</label>
...
<style>
    @media(min-width:320px){
        .jp-card-container .jp-card .jp-card-front {
            width:75% !important;
        }
    }
