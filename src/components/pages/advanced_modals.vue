...
<div>
    <b-card header="Modals" header-tag="h4" class="bg-primary-card">
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <b-card >
                    <b-btn v-b-modal.modal7>Launch modal Events</b-btn>
                    <!-- Modal Component -->
                    <b-modal id="modal7" title="Modal" @shown="shown" @hidden="hidden" @ok="success" @cancel="cancel">
                        <h1>modal</h1>
                    </b-modal>
                </b-card>
            </div>
...
<style src="../../vendors/animate.css/animate.min.css" scoped></style>
<style src="../../assets/css/custom_css/advanced_modals.css"></style>
