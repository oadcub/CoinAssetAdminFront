<template>
    <div class="row">
        <div class="col-lg-12">
            <b-card header="Administrator List" header-tag="h4" class="bg-primary-card">
                <div class="table-responsive">
                    <datatable title="Administrator List" :rows="tableData" :columns="columndata"></datatable>
                </div>
            </b-card>
        </div>
    </div>
    ...
    export default {
        ...
        mounted() {
            ...
            this.tableData.forEach((item, index) => {
                this.$set(item, "action", "<a class='btn btn-info' href='#/addnew_admin'>Edit</a>");
            });
        }
    }
</script>
